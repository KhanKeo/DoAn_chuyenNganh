      ...
      <form  name="register" action="admin_form_edit_db.php" method="POST" id="register" class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-5" align="left">
            <font color="red"> *phease enter all box </font>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <div class="col-sm-3" align="right"> full name  </div>
          <div class="col-sm-5" align="left">
            <input  name="admin_name" type="text" required class="form-control" id="admin_name" value="<?=$admin_name;?>"placeholder="fullname" />
          </div>
        </div>

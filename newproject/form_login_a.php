...
<div class="container" style="padding-top:100px">
  <div class="row">
    ...
    <div class="col-md-4" style="background-color:#D6EAF8">
      ...
      Form Login </h3>
      <!-- <div>
      <img class="img_login_admin" src="backend/dist/img/login_a.jpeg" alt="Admin Img">
      </div> -->
      <form  name="formlogin" action="login_a.php" method="POST" id="login" class="form-horizontal">
        <div class="form-group">
          <div class="col-sm-12">
            <input type="text"  name="admin_user" class="form-control" required placeholder="Username" />
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-12">
